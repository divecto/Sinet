...
import os
import argparse
import matplotlib.pyplot as plt  # Menggunakan matplotlib untuk menyimpan gambar
import pandas as pd
...
parser.add_argument('--result_file', type=str,
                    default='./Result/2020-CVPR-SINet-New/results.csv')  # Path untuk menyimpan hasil CSV
opt = parser.parse_args()

# Load model SINet_ResNet50 dan pindahkan ke GPU
